...
Requests 1232 (1232 answered), input tokens 1969192, cost $0.0827; recording hits 1232, misses 0; 644 rows with both arms scored.

## Bars (pre-registered decision table, first match wins)

AUROC 0.855 (bootstrap 95% 0.836 to 0.874), mutator-word baseline 0.617.
...
| glam-sdk-java/services#services#SingleAssetFulfillmentServiceEntrypoint.main#RemoveConditionalMutator_EQUAL_IF#NO_COVERAGE#39 | 0.930 | 0.900 | 0.330 | 0.910 |
| glam-sdk-java/services#services#SingleAssetFulfillmentServiceEntrypoint.main#RemoveConditionalMutator_EQUAL_IF#NO_COVERAGE#46 | 0.930 | 0.900 | 0.370 | 0.940 |
| ravina/ravina-solana#epoch#SlotPerformanceStats.calculateStats#RemoveConditionalMutator_EQUAL_ELSE#SURVIVED#81 | 0.930 | 0.900 | 0.170 | 0.990 |
| sava/sava-core#token2022#ConfidentialMintBurn.read#MathMutator#SURVIVED#36 | 0.930 | 0.890 | 0.080 | 1.000 |
